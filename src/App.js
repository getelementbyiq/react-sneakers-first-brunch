    ...
    <div className="wrapper clear">
        <header className='d-flex justify-between align-center p-40'>
          <div className='d-flex align-center'>
              ...
              <div className='headerInfo ml-20'>
                <h3 className='text-uppercase '> React Sneaker</h3>
                <p className="opacity-5"> Get fly! get touch with your dreams!</p>
              </div>
          </div>
        ...
        <div className='content p-40 '>
              <h1 className='mb-40'> Alle Sneakers</h1>
              
        <div className='d-flex '>
          <div className='card'>
            <img width={133} height={112} src='/img/sneakers/1.jpg' alt='' />

            <h5>Grüne Nike Airs original vom Film Red Green Nikes</h5>
